...
\includegraphics[width=0.7\textwidth,height=\textheight]{../results/horse_pops_plot.png}
...
span as Figure~\ref{fig-horse_pops_plot}.
...
\caption{\label{fig-horse\_pops\_plot\_largest\_sd}Horse populations for
the province with the largest standard deviation}

\end{figure}%

In Figure~\ref{fig-horse_pops_plot_largest_sd} we zoom in and look at
the province of Saskatchewan which had the largest spread of values in
